...
public class ReservationQueryService {
    ...
    public Slice<Reservation> findByShopIdWithFilterAndCursor(
        ...
        return reservationRepository.findByShopIdWithFilterAndCursor(shopId, status, cursor, pageable);
    }
    ...
    public Slice<Reservation> findByShopIdsWithFilterAndCursor(
        ...
        Pageable pageable = PageRequest.of(0, size, Sort.by(Sort.Direction.DESC, "id"));
        return reservationRepository.findByShopIdsWithFilterAndCursor(shopIds, status, cursor, pageable);
    }

    public List<ReservationSummaryDto> findSummariesByOwnerWithCursor(
