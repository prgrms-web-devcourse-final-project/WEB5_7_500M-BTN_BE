...
public class ShopController {
    ...
    @Operation(summary = "사장이 가진 식당들 조회", description = "사장 한명이 가진 식당들 리스트들을 조회합니다. 상태 상관없이 조회 (Completed)")
    ...
    @Operation(summary = "사장의 식당 상세 조회", description = "특정 식당의 상세 정보를 조회합니다. 자신 식당 상태가 APPROVED인 식당들만 조회 가능 (Completed)")
    ...
    @Operation(summary = "식당 목록 조회", description = """
        위치 기반으로 식당 목록을 조회합니다. 식당 상태가 APPROVED인 식당들만 조회 가능 (Completed)
