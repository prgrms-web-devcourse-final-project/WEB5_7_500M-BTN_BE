...
public class QChatMessage extends EntityPathBase<ChatMessage> {
    ...
    private static final long serialVersionUID = -512111836L;
    ...
    public final shop.matjalalzz.user.entity.QUser sender;
    ...
    public QChatMessage(Class<? extends ChatMessage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sender = inits.isInitialized("sender") ? new shop.matjalalzz.user.entity.QUser(forProperty("sender")) : null;
    }
